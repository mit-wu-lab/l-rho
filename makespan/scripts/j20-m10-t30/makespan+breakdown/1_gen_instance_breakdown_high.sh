...
export NUM_MACHINE_BREAKDOWN_P=0.5
export FIRST_BREAKDOWN_BUFFER_LB=50
export FIRST_BREAKDOWN_BUFFER_UB=150
export MACHINE_BREAKDOWN_DURATION_LB=50
export MACHINE_BREAKDOWN_DURATION_UB=50
export BREAKDOWN_BUFFER_LB=100
export BREAKDOWN_BUFFER_UB=200
export BREAKDOWN_SUFFIX=high

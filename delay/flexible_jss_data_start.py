import numpy as np
from makespan.flexible_jss_data_common import FlexibleJSSData, get_task_index, get_edges, get_dummy_label, get_label


def get_data(jobs_data_sel, n_machines, scheduled_starts_sel, machines_start_time, jobs_start_time,
...
def get_rollout_data(jobs_data_sel, n_machines, scheduled_starts_sel, machines_start_time, jobs_start_time,
                     overlapping_task_indices, overlapping_jobs_solution_all, overlapping_machines_assignment_all):
    x_tasks, tasks_tuple, tasks_dict, x_machines, \
        overlap_machine_task_edge_idx, overlap_machine_task_edge_val, \
        other_machine_task_edge_idx, other_machine_task_edge_val, \
...
def get_state(jobs_data_sel, n_machines, scheduled_starts_sel, machines_start_time, jobs_start_time,
              overlapping_task_indices, overlapping_jobs_solution_all, overlapping_machines_assignment_all):
    task_tuple, tasks_dict = get_task_index(jobs_data_sel)

    x_tasks = get_tasks_features(tasks_dict, jobs_data_sel, scheduled_starts_sel,
...
def get_tasks_features(tasks_dict, jobs_data_sel, scheduled_starts_sel,
                       jobs_start_time, overlapping_task_indices, overlapping_jobs_solution_all):
    ...
    for job_id, job in jobs_data_sel.items():
        for task_id, task in job.items():
            ...
            task_input_feature = [job_start_time, scheduled_task_start_time,
                                  ...
                                  alt_delay, alt_machine, alt_duration,
